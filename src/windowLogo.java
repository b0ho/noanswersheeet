...
import javax.swing.UIManager.LookAndFeelInfo;
    ...
    /**
     * 최초 실행 시 보이는 로고 윈도우 입니다. <br>
     * 로고 윈도우는 프로그램 로딩을 완료하면 종료됩니다 <br>
     * 종료 후 메인 윈도우가 실행됩니다.
     *
     * @author 김선일
     *
     */
    public class windowLogo implements Runnable {

        /** 사용자 모니터 해상도를 가져오기 위한 속성 */
        private Toolkit tk = Toolkit.getDefaultToolkit();
        /** 사용자 모니터의 가로 해상도 */
        private int screensize_width = (int) tk.getScreenSize().getWidth(); // 가로
        // 해상도
        /** 사용자 모니터의 세로 해상도 */
        private int screensize_height = (int) tk.getScreenSize().getHeight();// 세로
        // 해상도
        /** 프레임 가로 크기 */
        ...
        public static void main(String args[]) {
            ...
            windowLogo windowLogo = new windowLogo();
            new Thread(windowLogo).start();
        }
